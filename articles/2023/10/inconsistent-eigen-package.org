...
- library [[https://conybeare.us/git/xo-kalmanfilter][xo-kalmanfilter]] depends on eigen
- library [[https://conybeare.us/git/xo-pykalmanfilter][xo-pykalmanfilter]] depends on =xo-kalmanfilter=
- the project [[https://github.com/Rconybea/xo-umbrella2][xo-umbrella2]] incorporates both codebases (along with others) into a single source tree
  (using git subrepo).
