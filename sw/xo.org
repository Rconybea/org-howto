...
* Python Libraries
  ...
  [[https://github.com/xo-pywebsock][xo-pywebsock]] in-memory http server; can expose entirely-native publishing pipeline via websockets.
  [[https://github.com/rconybea/xo-pywebutil][xo-pywebutil]] lo-level abstractions for http: endpoints, attribute lists.
  [[https://github.com/pykalmanfilter][xo-pykalmanfilter]] linear kalman filter with simulation support.
...
* C++ Libraries
  ...
  [[https://github.com/xo-webutil][xo-webutil]] low-level abstractions for http: endpoints, attribute lists.
  ...
  [[https://github.com/xo-simulator][xo-simulator]] deterministic event-based simulation
  ...
  [[https://github.com/xo-ordinaltree][xo-ordinaltree]] header-only. fast in-memory B+ tree, red-black tree w/ ordinal statistics.
  [[https://github.com/rconybea/xo-randomgen][xo-randomgen]] header-only. fast pseudo random number generators. xoshiro**,
  [[https://github.com/rconybea/xo-callback][xo-callback]] header-only. reentrant callback set
  [[https://github.com/rconybea/xo-subsys][xo-subsys]] orderly startup and shutdown for subsystems with plugin features
  [[https://github.com/rconybea/xo-reflect][xo-reflect]] reflection library
  [[https://github.com/rconybea/xo-refcnt][xo-refcnt]] intrusive reference counting
  [[https://github.com/rconybea/xo-indentlog][xo-indentlog]] header-only logging library; colorized output with indentation tracking program call structure
